...
import { computeIecVoltageBands, computeAbsoluteVoltageBands, clamp, r1 } from '../mccCalculations';
      ...
      <Grid container spacing={2} alignItems="center" sx={{ mb: 1.25 }}>
        <Grid item xs={12} md={4}>
          <Typography variant="body1" sx={{ fontWeight: 600 }}>
            {`Input ${fieldPrefix.toUpperCase()} Voltage (${unit})`} <span style={{ color: 'red' }}>*</span>
          </Typography>
        </Grid>

...
export const seedLtDefaults = (initial = {}) => {
  const patch = { ...initial };
...
export const applyLtChange = (fieldId, newData) => {
...
export const validateLtPowerStep = (fields, formData) => {
...
export const resetLtStep = (fields) => {

...
import FormPreview from '../lt-form/FormPreview';
import { applyLtChange } from '../lt-form/ltCalculations';
...
export default function HtFields({ fields = [], formData, setFormData, errors = {}, setErrors }) {

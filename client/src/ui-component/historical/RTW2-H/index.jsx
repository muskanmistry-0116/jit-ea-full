...
const simulateApiData = () => {
  ...
  for (let i = 0; i < DAY_IN_MINUTES; i++) {
    ...
    if (hour === 3 || hour === 10) {
      ...
      vr = 200 + cycleModifier + randomJitter;
      vy = 200 + cycleModifier + randomJitter * 1.2;
      vb = 250 + cycleModifier + randomJitter * 0.8;
      independent_v_avg = 250 + cycleModifier + (Math.random() - 0.5) * 15;
    }
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        <div style={styles.title}>3PH L-N VOLTAGE HISTORICAL PLOT</div>

...
// //   if (!apiData || apiData.length === 0) return { labels: [], deviationData: [], imbalanceData: [] };

// //   const hourlyData = {};
// //   apiData.forEach((item) => {
// //     const hour = new Date(item.TS).getHours();
// //     if (!hourlyData[hour]) {
// //       // It now collects deviation and imbalance values
...
// //     // It no longer calculates, it just finds the average of the provided values
...
// //       }
// //     ],
// //     // --- CHANGE: Added the missing dataZoom configuration ---
// //     dataZoom: [
// //       {
// //         type: 'inside',
// //         start: 0,
...
// //       pieces: [
// //         { lt: 2.5, color: '#91CC75' }, // Acceptable (Green)
// //         { gte: 2.5, lt: 4, color: '#ffce56' }, // Warning (Yellow)
// //         { gte: 4, color: '#ff5252' } // Critical (Red)
// //       ]
// //     },
// //     tooltip: {
// //       trigger: 'axis',
...
//         name: 'Max Deviation %',
//         position: 'left',
//         // --- CHANGE: Set the number of segments for the axis ---
//         splitNumber: 5 // This will create 6 grid lines
//       },
//       {
//         type: 'value',
//         name: 'Voltage Imbalance %',
